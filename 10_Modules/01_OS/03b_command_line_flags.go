...
// To get the usage
// go run 03b_command_line_flags.go -h
// go run 03b_command_line_flags.go --help

// Usage
// go run 03b_command_line_flags.go -word=opt -numb=7 -fork -svar=flag

// When some args were not given, they will take default values
// go run 03b_command_line_flags.go -word=opt

// Trailing positional arguments can be provided after any flags.
// go run 03b_command_line_flags.go -word=opt a1 a2 a3
