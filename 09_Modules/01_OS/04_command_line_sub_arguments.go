...
go run 04_command_line_sub_arguments.go foo -enable -name=joe a1 a2
go run 04_command_line_sub_arguments.go bar -level 8 a1

But bar won’t accept foo’s flags.
go run 04_command_line_sub_arguments.go foo bar -enable a1
